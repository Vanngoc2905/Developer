        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceHistories_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InvoiceHistories_Bans_BanId",
                        column: x => x.BanId,
                        principalTable: "Bans",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InvoiceHistories_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    IngredientId = table.Column<int>(type: "int", nullable: false),
                    AmountNeeded = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceHistories_ApplicationUserId",
                table: "InvoiceHistories",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceHistories_BanId",
                table: "InvoiceHistories",
                column: "BanId");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceHistories_OrderId",
                table: "InvoiceHistories",
                column: "OrderId");
